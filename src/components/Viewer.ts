...
const Viewer: m.ClosureComponent<ViewerAttrs> = ({
  attrs: { actData$, actDataSync$, syncDate$, sync },
}) => {
  // Modes:
  //   Viewing all acts
          ...
          m(".Viewer-right", [
            ...
            m(
              ...
              m(
                "",
                "You are using ",
                m("span.Viewer-strava-atlas", "Strava Atlas"),
                ". ",
                "View source ",
                m(
                  "a",
                  { href: "https://github.com/joshuahhh/strava-atlas" },
                  "on GitHub",
                ),
                ".",
              ),
              m(
                ...
                actDataSync$()
                  ? [
                      "Sync in progress: ",
                      m(
                        "span.Viewer-loading-progress.Shared-loading-progress",
                  ...
                  : [
                      ...
                      m(
                        "button",
                        { onclick: () => sync({ fromScratch: false }) },
                        "Sync now",
                      ),
                      m(
                        "details.Viewer-advanced-details",
                        m("summary", "Advanced"),
                        m(
                          ".Viewer-advanced-controls",
                          m(
                            "button",
                            { onclick: () => sync({ fromScratch: true }) },
                            "Sync from scratch",
                          ),
                          selectedActId$() &&
                            m(
